...
API предоставляет актуальную матрицу занятости и доступности учебных аудиторий по всем ключевым корпусам университета на 14 дней вперед.
...
- **Периодичность обновления**:
  ...
  - Средний размер payload: ~170–200 КБ.
