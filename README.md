...
>
> Приложение отправляет анонимную статистику использования и отчёты о падениях (Яндекс AppMetrica) — без личных данных и аккаунтов. При первом запуске приложение спрашивает разрешение; позже включается/отключается в настройках («Отправлять анонимную статистику»).
